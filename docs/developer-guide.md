...
This guide provides comprehensive information for developers contributing to or extending the Image Project Manager application.
...
Image Project Manager is a full-stack application for managing, classifying, and collaborating on visual content.
