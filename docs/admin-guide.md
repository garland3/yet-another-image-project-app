...
- [Quick Start Installation](admin/installation.md#docker-deployment-recommended)
...
Image Project Manager is a full-stack web application for managing, classifying, and collaborating on visual content.
