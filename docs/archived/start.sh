...
# =============================================================================
# Unified Startup Script for Image Project Manager
# =============================================================================
...
Environment Variables:
  CONTAINER_ENGINE      Container engine to use (docker or podman, default: docker)
...
main() {
    ...
    # Show banner
    section "Image Project Manager - Startup"
