...
- **Purpose:** Full‑stack Image Project Manager for organizing images, custom classifications, comments, metadata, and ML analysis overlays.
...
- **Infra:** PostgreSQL + MinIO via `docker-compose.yml`; Kubernetes manifests in `deployment-test/`.
